...
class _$UserDataImpl implements _UserData {
  ...
  @override
  String toString() {
    return 'UserData(id: $id, email: $email, userName: $userName, password: $password, imagePath: $imagePath, zipCode: $zipCode, schedule: $schedule, pets: $pets)';
  }
...
abstract class _UserData implements UserData {
  const factory _UserData(
      ...
      final String? zipCode,
      final List<String>? schedule,
      final List<String>? pets}) = _$UserDataImpl;
