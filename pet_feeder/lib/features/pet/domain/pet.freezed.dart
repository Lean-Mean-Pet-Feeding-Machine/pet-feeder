...
mixin _$Pet {
  ...
  double? get bcsScore => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      breed: freezed == breed
          ...
          : breed // ignore: cast_nullable_to_non_nullable
              as String?,
      bcsScore: freezed == bcsScore
          ? _value.bcsScore
          : bcsScore // ignore: cast_nullable_to_non_nullable
              as double?,
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.bcsScore, bcsScore) ||
                other.bcsScore == bcsScore) &&
